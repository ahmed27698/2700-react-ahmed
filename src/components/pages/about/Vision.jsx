...
export default function Vision() {
    return (
        <Container>
            <MainTitle title='Vision' icon='BsEyeglasses' />
            <p>Our vision is lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta quo explicabo distinctio, velit quasi consequuntur? Atque sit eum porro dolorem, quos dolor tempora aspernatur praesentium sed nobis facere rerum perspiciatis.</p>
            ...
            <p>Hic quam doloremque, perspiciatis minus repellat mollitia optio esse id eum cumque harum totam officia ratione beatae eligendi? Nostrum sunt, perspiciatis repellat similique fugit molestias eum magnam cupiditate. Quod, minus.</p>
            <p>Pariatur dolorum quae perspiciatis facere magnam ex at eveniet laborum, est ea ipsum, natus quam, tempora reiciendis incidunt accusamus consequatur esse distinctio odio sint totam accusantium! Culpa beatae placeat atque.</p>
            <p>Id distinctio aliquam corrupti sit tempore recusandae alias! Deserunt molestiae, earum sunt esse necessitatibus fugiat consequuntur quas quo rerum! Incidunt modi numquam tempore. Voluptatibus, dicta in explicabo recusandae ipsam possimus.</p>
            <p>Soluta et ab tenetur delectus laborum expedita? Eveniet, modi dolor repellat architecto cupiditate quam esse laudantium nobis. Amet, expedita, laborum veniam nulla quae, hic laudantium rem recusandae consequatur harum alias!</p>
